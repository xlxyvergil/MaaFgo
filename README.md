...
| 大活动 | 适配有独立地图的大型活动，自动找上次挑战副本 |
| 小活动 | 适配无地图的小型活动，支持倒数选择副本 |
...
> ⚠️ **雷电 14 注意**：雷电 14 模拟器上部分功能可能不可用，例如自动启动游戏、任务结束后自动关闭游戏。建议使用雷电 9、MuMu 等模拟器以获得完整体验。
